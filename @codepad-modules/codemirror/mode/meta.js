...
CodeMirror.modeInfo = [
    ...
    { name: "GitHub Flavored Markdown", mime: "text/x-gfm", mode: "gfm", file: /^(README|readme|contributing|history).md$/i },
    ...
    { name: "HTML", mime: "text/html", mode: "htmlmixed", ext: ["html", "htm", "handlebars", "hbs", "svelte"], alias: ["xhtml"] },
