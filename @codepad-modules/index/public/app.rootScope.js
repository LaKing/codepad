...
*/
        $rootScope.pad_at = function(path) {
            if (!path) return false;
            return $rootScope.pad.substring(2, path.length+3) === path + '/';
        };
        ...
        $rootScope.live = function() {
            var re = new RegExp("/", "g");
            var c = url.split(":")[1].replace(re, "");
            $window.open("https://" + c + ":9000", "_blank");
        };
        $rootScope.restart_server = function() {
            var re = new RegExp("/", "g");
            var c = url.split(":")[1].replace(re, "");
            $window.open("https://" + c + "/restart.server", "_blank");
        };
        ...
        $rootScope.plug_anboilerplated_play = function() {
